...
public class FolderActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private FolderAdapter.OprationListener oprationListener=new FolderAdapter.OprationListener(){
        ...
        public void delete(final Directory directory) {
            ...
            Toast.makeText(FolderActivity.this, requestResult.msg, Toast.LENGTH_SHORT).show() ;
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            if (!Thread.currentThread().isInterrupted())
            {
                ...
                {
                    case 0:
                        Toast.makeText(FolderActivity.this, "传输开始", Toast.LENGTH_SHORT).show();
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Toast.makeText(FolderActivity.this, "传输完成", Toast.LENGTH_SHORT).show();
